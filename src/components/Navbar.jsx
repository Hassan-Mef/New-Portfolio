...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-black bg-opacity-90 text-white shadow-md z-50 border-b-white-100">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3 md:px-6">
        ...
        <div className="hidden lg:flex">
          <button className="bg-white text-black px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 hover:scale-105 transition-transform">
            <span>💼</span> Hire Me
          </button>
        </div>
      ...
      {isOpen && (
        <div className="lg:hidden px-6 pb-4">
          <ul className="flex flex-col space-y-4 text-sm font-medium">
            ...
            <li>
              <button className="bg-white text-black px-4 py-2 rounded-full font-medium w-full mt-2">
                💼 Hire Me
              </button>
            </li>
          </ul>
